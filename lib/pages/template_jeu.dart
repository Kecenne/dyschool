                    ...
                    children: [
                      ...
                      Center(
                        child: Text(
                          game['title'],
                          style: TextStyle(
                            fontSize: settingsState.fontSize * 2.5,
                        ...
                        builder: (context, snapshot) {
                          ...
                          return Row(
                            ...
                            children: [
                              ...
                              Text(
                                formattedTime, 
                                style: TextStyle(fontSize: settingsState.fontSize * 1.5)
                              ),
                      ...
                      Text(
                        "Explication du jeu",
                        style: TextStyle(
                          fontSize: settingsState.fontSize * 1.5,
                          fontWeight: FontWeight.bold
                        ),
                      ),
                      const SizedBox(height: 16.0),
          ...
          child: Column(
            ...
            children: [
              Text(
                title,
                style: TextStyle(
                  fontSize: settingsState.fontSize * 1.25,
                  fontWeight: FontWeight.bold,
